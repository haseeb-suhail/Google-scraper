...
keywords = [
    "exotic snack guys", "order exotic snacks", "exotic snacks", "the hot box exotic snack",
    "exotic snack city", "exotic snacks global", "brookwood exotic snacks", "half blazed exotic snacks",
    "exotic snack city", "order exotic snacks", "new exotic snacks rus", "tj exotic snacks",
    "exotic snacks", "exotic snacks sd", "brookwood exotic snacks", "exotic snack guys",
    "exotic snack distribution", "exotic snack guys", "exotic snack city", "exotic snack hub",
    "order exotic snacks", "exotic snack hub", "the exotic snack spot", "exotic snack guys online",
    "dmv exotic snack", "exotic snack hub", "exotic snack shop"
]
...
output_csv = open('Exotic_Snacks_Data.csv', 'w', newline='', encoding='utf-8')
writer = csv.writer(output_csv)
headers = ['Keyword', 'Company Name', 'Full Address', 'Category', 'Phone No', 'Company Website', 'Google Map Url']
writer.writerow(headers)

# Function to extract data for a single keyword
def extract_data_for_keyword(keyword):
    ...
    for result in results_found:
        try:
            ...
            writer.writerow([keyword, Company_Name, Full_address, Category, Phone_number, Company_website, Google_map_link])
...
# Loop through each keyword and extract data
for keyword in keywords:
    extract_data_for_keyword(keyword)
